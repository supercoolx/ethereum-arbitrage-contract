...
import { IUniswapFlash } from "../flashloans/interfaces/IUniswapFlash.sol";
...
contract RouterRegistry is 
    ...
    IUniswapFlash public immutable uniswapFlash;
    uint routerCount;
    constructor (address _uniswapFlash) {
        uniswapFlash = IUniswapFlash(_uniswapFlash);
        initRoterInstances();
    }
