...
import { IDODOV2Proxy } from "../interfaces/IDODO.sol";
...
contract DodoswapRouter {
    ...
    */
    function dodoSwapV1(
        ...
        // dodoV1Pool = 0xBe60d4c4250438344bEC816Ec2deC99925dEb4c7; //BSC USDT - BUSD (BUSD as BaseToken, USDT as QuoteToken)
        ...
        */
        ...
        amountOut = IDODOV2Proxy(dodoswapProxy).dodoSwapV1(
            path[0],
            path[1],
            amountIn,
            amountOutMin,
